...
const translations: Record<string, Record<Language, string>> = {
  ...
  'filter.relevance': { tr: 'İLGİLİLİK', en: 'RELEVANCE' },
  ...
  'filter.relevance_very_low': { tr: 'Çok Düşük', en: 'Very Low' },
  'filter.relevance_low': { tr: 'Düşük', en: 'Low' },
  'filter.relevance_medium': { tr: 'Orta', en: 'Medium' },
  'filter.relevance_high': { tr: 'Yüksek', en: 'High' },
  'filter.relevance_very_high': { tr: 'Çok Yüksek', en: 'Very High' },
